<?php namespace App\Http\Controllers;
	...
	class AdminKaryawanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Hp','name'=>'hp','type'=>'number','validation'=>'required|numeric','width'=>'col-sm-6','placeholder'=>'You can only enter the number only'];
			$this->form[] = ['label'=>'jenis_kelamin','name'=>'jk','type'=>'select2','validation'=>'required','width'=>'col-sm-9','dataenum'=>'Laki-laki ; Perempuan'];
	    ...
	    */
		...
		// 	$data['page-title'] = "Halaman Karyawan";

		// 	$data['karyawan'] = DB::table('karyawan')->paginate(10);

		// 	return $this->view('karyawan.index' , $data);
